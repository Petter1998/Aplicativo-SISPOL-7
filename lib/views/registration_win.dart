...
class RegistrationWin extends StatelessWidget {
  const RegistrationWin({super.key});
        ...
        child: Column (
          ...
          children: [
            ...
            Padding (
              ...
              child: Text(
                '¡Felicidades! Tu registro en SISPOL-7 ha sido completado. Accede a tu cuenta para comenzar. \n !GRACIAS¡',
                style: 
