...
import 'package:sispol_7/widgets/emergency/floating_veh_part.dart';
...
class RegistrationVehiclePartWins extends StatelessWidget {
  RegistrationVehiclePartWins({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: const MyUSER10(),
      body: Center(
        child: Column (
