...
class RegistrationVehiclePartScreen extends StatefulWidget {
  const RegistrationVehiclePartScreen({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _RegistrationVehiclePartScreenState createState() => _RegistrationVehiclePartScreenState();
}

class _RegistrationVehiclePartScreenState extends State<RegistrationVehiclePartScreen> {
  ...
  void _registerVehicle() {
    ...
    // Establece peligrosidad predeterminada si está vacío
    String peligrosidad = _peligController.text.isEmpty ? 'Sin definir' : _peligController.text;
