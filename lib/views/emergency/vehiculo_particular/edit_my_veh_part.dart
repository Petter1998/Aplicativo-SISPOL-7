...
class EditMyVehiclePartScreen extends StatefulWidget {
  final Vehicle vehicle;
  

  const EditMyVehiclePartScreen({super.key, required this.vehicle});

  @override
  // ignore: library_private_types_in_public_api
  _EditMyVehiclePartScreenState createState() => _EditMyVehiclePartScreenState();
}

class _EditMyVehiclePartScreenState extends State<EditMyVehiclePartScreen> {
  ...
  late TextEditingController _peligController;
  ...
  late TextEditingController _kilometrajeAController;
  ...
  void initState() {
    ...
    _peligController = TextEditingController(text: widget.vehicle.pelig);
    ...
    _kilometrajeAController = TextEditingController(text: widget.vehicle.kilometrajeA.toString());
              ...
              child: Column(
                children: [
                  ...
                  TextField(
                    ...
                    decoration: const InputDecoration(
                      labelText: 'Kilometraje Inicial del Vehiculo',
                  ...
                  TextField(
                    controller: _kilometrajeAController,
                    decoration: const InputDecoration(
                      labelText: 'Kilometraje Actual del Vehiculo',
                      hintText: 'Kilometraje del Vehiculo',
                      fillColor: Colors.black,
                      border: OutlineInputBorder(),
                    ),
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () async {
                      final updatedVehicle = Vehicle(
                        ...
                        kilometrajeA: int.tryParse(_kilometrajeAController.text) ?? 0,
                        responsable1: _responsable1Controller.text,
                        fechacrea: DateTime.now(),
                      );
                       await VehiclePartController().updateMyVehiclePart(context, updatedVehicle);
                    },
                    child: Text(
                      'Guardar cambios', 
