...
import 'package:sispol_7/views/emergency/bonus/search_bonus.dart';
...
class BonusView extends StatefulWidget {
  ...
  _BonusViewState createState() => _BonusViewState();
}
              ...
              onPressed: () async {
                ...
                if (results.isEmpty) {
                  ...
                  Navigator.of(context).push(
                    MaterialPageRoute(
                      builder: (context) => SearchBonusView(searchResults: results),
                    ),
                  );
                }
              },
            ...
            children: [
              ...
              pw.TableHelper.fromTextArray(
                headers: <String>[
                  ...
                  'Propietario', 'Fecha de Creación', 'Bono'
                ],
                data: _vehicles.map((vehicle) => [
                  ...
                  '\$${calculateBonus(vehicle.kilometraje, vehicle.kilometrajeA, vehicle.pelig).toStringAsFixed(2)}', // Calcula y muestra el bono
                ]).toList(),
