...
class ReportWins extends StatelessWidget {
  ReportWins({super.key, required this.reportData});
        ...
        build: (pw.Context context) => [
          pw.Column(
            ...
            children: [
              ...
              pw.Text('Detalles de este Reporte en Sispol - 7', style: pw.TextStyle(fontSize: 18, fontWeight: pw.FontWeight.bold)),
              pw.SizedBox(height: 20),
              _buildRichText('Fecha de Solicitud: ', reportData['fechaSolicitud'] ?? 'No proporcionado'),
              pw.SizedBox(height: 14),
              _buildRichText('Fecha de Registro: ', reportData['fechaRegistro'] ?? 'No proporcionado'),
              pw.SizedBox(height: 14),
              _buildRichText('Fecha de Entrega del Vehículo: ', reportData['fechaEntrega'] ?? 'No proporcionado'),
              pw.SizedBox(height: 14),
              _buildRichText('Responsable que entregó el vehículo: ', reportData['responsableEntrega'] ?? 'No proporcionado'),
              pw.SizedBox(height: 14),
              _buildRichText('Responsable que retira el vehículo: ', reportData['responsableRetira'] ?? 'No proporcionado'),
              pw.SizedBox(height: 14),
              _buildRichText('Kilometraje Actual: ', reportData['kilometrajeActual'].toString()),
              pw.SizedBox(height: 14),
              _buildRichText('Kilometraje para el Próximo Mantenimiento: ', reportData['kilometrajeProximoMant'].toString()),
              pw.SizedBox(height: 14),
              _buildRichText('Tipo de Mantenimiento: ', reportData['tipoMantenimiento'] ?? 'No proporcionado'),
              pw.SizedBox(height: 14),
              _buildRichText('Mantenimiento Complementario: ', reportData['mantenimientoComplementario'] ?? 'No proporcionado'),
              pw.SizedBox(height: 14),
              _buildRichText('Observaciones: ', reportData['observaciones'] ?? 'No proporcionado'),
        ...
        child: Column (
          ...
          children: [
            ...
            Padding (
              ...
              child: Text(
                '¡Felicidades! Esta Orden de trabajo finalizada ha sido guardado en SISPOL-7.\n!GRACIAS¡',
                style: 
            ...
            Center(
              child: ElevatedButton(
                ...
                child: Text('Generar Reporte', style: GoogleFonts.inter(fontSize: titleFontSize, fontWeight: FontWeight.bold,color: Colors.black)),
              ),
            ),
          ],
        ),   
