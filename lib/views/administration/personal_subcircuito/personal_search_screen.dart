...
class PersonSearchResultView extends StatefulWidget {
  final List<Personal> searchResults;

  const PersonSearchResultView({super.key, required this.searchResults});

  @override
  // ignore: library_private_types_in_public_api
  _PersonSearchResultViewState createState() => _PersonSearchResultViewState();
}

class _PersonSearchResultViewState extends State<PersonSearchResultView> {
  // ignore: unused_field
          ...
          return pw.Table.fromTextArray(
            headers: <String>[
              ...
              'Ciudad de Nacimiento', 'Teléfono', 'Rango', 'Dependencia', 'Fecha de Creación'],
               data: widget.searchResults.map((personal) => [
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: DataTable(
          ...
          rows: widget.searchResults.map((personal) {
            return DataRow(
