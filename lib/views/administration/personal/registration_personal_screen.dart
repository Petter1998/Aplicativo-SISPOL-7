...
class RegistrationPersonalScreen extends StatefulWidget {
  const RegistrationPersonalScreen({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _RegistrationPersonalScreenState createState() => _RegistrationPersonalScreenState();
}

class _RegistrationPersonalScreenState extends State<RegistrationPersonalScreen> {
              ...
              child: Column(
                children: [
                  ClipRRect(
                    ...
                    child: Icon(
                      Icons.person_add, // Icono de usuario
