          ...
          pw.Column(
            ...
            children: [
              ...
              pw.SizedBox(height: 10),
                pw.Row(
                  ...
                  children: [
                    ...
                    pw.Column(
                      ...
                      children: [
                        pw.Text('Reporte de Vehículos asignado a Subcircuitos', style: pw.TextStyle(fontSize: 18, fontWeight: pw.FontWeight.bold)),
                ...
                pw.Text('Detalles del Vehículo - Subcircuito en Sispol - 7', style: pw.TextStyle(fontSize: 18, fontWeight: pw.FontWeight.bold)),
                pw.SizedBox(height: 10),
                ],
              ),
              pw.TableHelper.fromTextArray(
                headers: <String>[
                'ID', 'Marca', 'Modelo', 'Motor', 'Placa', 'Chasis', 'Tipo', 'CC',
                  'Cap Pas', 'Cap Car', 'Kilometraje', 'Dependencia',
