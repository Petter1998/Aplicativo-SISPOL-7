...
import 'package:sispol_7/widgets/administration/floating_cat_but.dart';
...
class RegistrationCatWins extends StatelessWidget {
  RegistrationCatWins({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: const MyUSER2(),
      body: Center(
        child: Column (
