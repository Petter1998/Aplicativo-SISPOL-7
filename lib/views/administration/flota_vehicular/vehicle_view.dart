...
import 'package:sispol_7/views/administration/flota_vehicular/search_vehicle_screen.dart';
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          style: GoogleFonts.inter(color: Colors.black),),
          content: Text('No se encontró ningún Vehiculo Policial con ese valores.',
          style: GoogleFonts.inter(color: Colors.black),),
          actions: <Widget>[
            TextButton(
              child: Text('OK',
