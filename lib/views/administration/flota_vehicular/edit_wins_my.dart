...
import 'package:sispol_7/widgets/administration/floating_my_veh.dart';
...
class RegistrationMyVehicleWins extends StatelessWidget {
  RegistrationMyVehicleWins({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: const MyUSER5(),
      body: Center(
        child: Column (
          ...
          children: [
            ...
            Padding (
              ...
              child: Text(
                '¡Felicidades! Esta actualización se ha guardado \n con éxito, en SISPOL-7. \n !GRACIAS¡',
                style: 
