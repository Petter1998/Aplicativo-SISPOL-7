...
import 'package:sispol_7/widgets/administration/floating_contrat_butt.dart';
...
class RegistrationContratWins extends StatelessWidget {
  RegistrationContratWins({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: const MyUSER1(),
      body: Center(
        child: Column (
