...
class MyUSE extends StatelessWidget {
  const MyUSE({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: FloatingActionButton.extended(
        ...
        icon: Icon(Icons.article, size: iconSize,color:  Colors.black),  // Aumenta el tamaño del icono
        label: Text('Ver Repuestos', style: GoogleFonts.inter(fontWeight: FontWeight.bold, color: Colors.black, fontSize: titleFontSize)),
