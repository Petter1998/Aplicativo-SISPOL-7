...
class CustomAppBar extends StatelessWidget implements PreferredSizeWidget {
  ...
  const CustomAppBar({super.key, this.title = 'Título por Defecto'})
      : preferredSize = const Size.fromHeight(55.0);  // Ajusta la altura según necesites
          ...
          children: [
            Align(
              ...
              child: Container(
                ...
                child: ClipRRect(
                  borderRadius: BorderRadius.circular(10.0), // Radio del borde redondo
                  child: Image.asset(
                    'assets/images/Escudo.jpg',
                    height: 52, // Altura de la imagen
            ...
            Expanded(
              child: Padding(
                ...
                child: Text(
                  'Policía Nacional del Ecuador - Subzona 7 Loja',
