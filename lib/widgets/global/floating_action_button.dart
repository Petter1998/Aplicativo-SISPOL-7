  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: FloatingActionButton.extended(
        ...
        icon: Icon(Icons.login, size: iconSize,color:  Colors.black),  // Aumenta el tamaño del icono
        label: Text('Iniciar Sesión', style: GoogleFonts.inter(fontWeight: FontWeight.bold, color: Colors.black, fontSize: titleFontSize)),
