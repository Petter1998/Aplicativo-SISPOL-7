  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: FloatingActionButton.extended(
        ...
        icon: Icon(Icons.co_present_outlined, size: iconSize,color:  Colors.black),  // Aumenta el tamaño del icono
        label: Text('Ver Personal', style: GoogleFonts.inter(fontWeight: FontWeight.bold, color: Colors.black, fontSize: titleFontSize)),
