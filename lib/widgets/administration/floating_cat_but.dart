...
class MyUSER2 extends StatelessWidget {
  const MyUSER2({super.key});
    ...
    return Container(
      ...
      child: FloatingActionButton.extended(
        onPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) =>  const CatalogosView()),
          );
        },
        icon: Icon(Icons.library_books_outlined, size: iconSize,color:  Colors.black),  // Aumenta el tamaño del icono
