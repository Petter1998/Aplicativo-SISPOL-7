...
class MyUSER24 extends StatelessWidget {
  const MyUSER24({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: FloatingActionButton.extended(
        ...
        icon: Icon(Icons.receipt_long_outlined, size: iconSize,color:  Colors.black),  // Aumenta el tamaño del icono
        label: Text('Ver Reportes', style: GoogleFonts.inter(fontWeight: FontWeight.bold, color: Colors.black, fontSize: titleFontSize)),
