  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: FloatingActionButton.extended(
        ...
        icon: Icon(Icons.receipt_long, size: iconSize,color:  Colors.black),  // Aumenta el tamaño del icono
        label: Text('Ver Ordenes de Trabajo', style: GoogleFonts.inter(fontWeight: FontWeight.bold, color: Colors.black, fontSize: titleFontSize)),
